...
<nav class="bg-blue-400">
    <div class="container mx-auto flex items-center justify-between">
        <!-- Logo -->
        <a href="#" class="py-3">
            <img src="logo.png" alt="Logo" class="w-52 h-auto mr-2">
        </a>

        <!-- Navigation Links -->
        <ul class="space-x-4 inline-flex text-sm"> <!-- Reduced font size -->
            <li><a href="#" class="text-blue-800 text-bold hover : text-blue-600">Home</a></li>
            <li><a href="#" class="text-blue-800 text-bold hover : text-blue-600">About</a></li>
            <li><a href="#" class="text-blue-800 text-bold hover : text-blue-600">Services</a></li>
            <li><a href="#" class="text-blue-800 text-bold hover : text-blue-600">Contact</a></li>
        </ul>
    </div>
</nav>
...
<div class="min-h-screen flex items-center justify-center">
    <div class="bg-opacity-40 bg-white p-4 rounded-lg shadow-lg">
        ...
        <form class="text-center inline-flex">
            ...
            <div class="p-4">
                <div>
                    <h1 class="mx-4 text-l font-bold text-gray-800">Job Seeker</h1>
                </div>
                <div>
                    <h1 class="mx-4 text-2xl font-bold text-gray-600 pb-8">Login form</h1>
                </div>
                <div class="mb-4">
